...
local globalkeys = gears.table.join(
    ...
    end, { description = "launch audio control", group = "launcher" }),
    ...
    awful.key({ modkey, altkey }, "j", function() awful.screen.focus_bydirection("down")
    end, { description = "Focus down screen", group = "client" }),
    awful.key({ modkey, altkey }, "k", function() awful.screen.focus_bydirection("up")
    end, { description = "Focus up screen", group = "client" }),
    awful.key({ modkey, altkey }, "h", function() awful.screen.focus_bydirection("left")
    end, { description = "Focus left screen", group = "client" }),
    awful.key({ modkey, altkey }, "l", function() awful.screen.focus_bydirection("right")
    end, { description = "Focus right screen", group = "client" }),

    awful.key({ modkey, altkey, 'Shift' }, "h", function()
        local focused_screen = awful.screen.focused()

        local s = focused_screen.get_next_in_direction("left")
    ...
    awful.key({ modkey, altkey, 'Shift' }, "l", function()
        local focused_screen = awful.screen.focused()
        local s = focused_screen.get_next_in_direction("right")
        client.focus:move_to_screen(s)
    end, { description = "Move client to right screen", group = "client" }),
    awful.key({ modkey, altkey, 'Shift' }, "j", function()
        local focused_screen = awful.screen.focused()
        local s = focused_screen.get_next_in_direction("down")
        client.focus:move_to_screen(s)
    end, { description = "Move client to down screen", group = "client" }),
    awful.key({ modkey, altkey, 'Shift' }, "k", function()
        local focused_screen = awful.screen.focused()
        local s = focused_screen.get_next_in_direction("up")
        client.focus:move_to_screen(s)
    end, { description = "Move client to up screen", group = "client" }),
